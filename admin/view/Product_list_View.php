    	...
    	<?php foreach ($data as $key => $value) {?>
            <tr>
                ...
                <td class="text-center">
                    <a class='btn btn-success btn-xs' href="admin.php?c=product_update&&id=<?php echo $value['id']; ?>">
                        <span class="glyphicon glyphicon-edit"></span> Edit
                    </a> 
                    <a href="admin.php?c=product_delete&&id=<?php echo $value['id']; ?>" class="btn btn-danger btn-xs">
